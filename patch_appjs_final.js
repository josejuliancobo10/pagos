...
const target2 = `function updateSummary() {
...
// Fallback regex replacement if exact string match fails due to line endings
...
const target3 = `document.getElementById('btnPayNowText').textContent = \`Autorizar Suscripción por \${firstTotal.toFixed(2)}\`;`;
// Not strictly needed to replace since the variable is named firstTotal already, but we will make sure.
