...
const replacement1 = `async function verifyAccessCode(code) {
...
js = js.replace(/async function verifyAccessCode\(code\) \{[\s\S]*?async function handlePaymentSubmit/m, () => replacement1);
